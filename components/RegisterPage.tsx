...
const RegisterPage: React.FC = () => {
  ...
  const showBranch =
    formData.designation.trim().toUpperCase() === "HOD" ||
    formData.designation.trim().toUpperCase() === "PROFESSOR";
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.branch) {
          ...
          localStorage.removeItem("faculty_branch");
        }
